...
class Slider_Control(QWidget):
    def __init__(self):
        ...
        self.SHOULDER_slider.setValue(100)
        ...
        self.WRISTx_slider.setValue(80)
        ...
        self.WRISTy_slider.setValue(90)
        ...
        self.WRISTz_slider.setValue(66)
